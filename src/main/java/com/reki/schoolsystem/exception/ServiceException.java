...
import com.reki.schoolsystem.base.BasedError;
import com.reki.schoolsystem.base.BasedErrorResponse;
...
public class ServiceException {
    ...
    ResponseEntity<?> handleGenericException(Exception ex) {
        ...
        basedError.setDescription("Internal server error: " + ex.getMessage());

        BasedErrorResponse basedErrorResponse = new BasedErrorResponse();
        basedErrorResponse.setError(basedError);

        return ResponseEntity.status(500).body(basedErrorResponse);
    }
